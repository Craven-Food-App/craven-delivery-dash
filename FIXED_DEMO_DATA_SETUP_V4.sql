-- Enhanced Driver Waitlist System - Demo Data Setup (FINAL VERSION)
...
-- Insert demo driver applications with correct column names
...
-- Toledo drivers
(gen_random_uuid(), 'John', 'Smith', 'john.smith@example.com', '419-555-0101', '1990-05-15', '123 Main St', 'Toledo', 'OH', '43601', 'car', 'Toyota', 'Camry', 2018, 'Silver', 'ABC123', 'DL123456789', 'OH', '2025-12-31', '1234', 'direct_deposit', '123456789', '5678', 'doc1.jpg', 'doc1.jpg', 'doc2.jpg', 'doc3.jpg', 'doc4.jpg', 'photo1.jpg', 'State Farm', 'SF123456789', 'pending', NOW() - INTERVAL '5 days', 25, 25, 1),
(gen_random_uuid(), 'Sarah', 'Johnson', 'sarah.johnson@example.com', '419-555-0102', '1988-03-22', '456 Oak Ave', 'Toledo', 'OH', '43602', 'car', 'Honda', 'Civic', 2020, 'Blue', 'DEF456', 'DL987654321', 'OH', '2026-03-15', '5678', 'cashapp', NULL, NULL, 'doc5.jpg', 'doc5.jpg', 'doc6.jpg', 'doc7.jpg', 'doc8.jpg', 'photo2.jpg', 'Geico', 'GC987654321', 'pending', NOW() - INTERVAL '3 days', 40, 40, 1),
(gen_random_uuid(), 'Mike', 'Davis', 'mike.davis@example.com', '419-555-0103', '1992-11-08', '789 Pine St', 'Toledo', 'OH', '43603', 'bike', 'Trek', 'FX 3', 2021, 'Black', 'N/A', 'DL456789123', 'OH', '2025-08-20', '9012', 'direct_deposit', '987654321', '1234', 'doc9.jpg', 'doc9.jpg', 'doc10.jpg', 'doc11.jpg', 'doc12.jpg', 'photo3.jpg', 'Progressive', 'PR456789123', 'pending', NOW() - INTERVAL '1 day', 10, 10, 1),

-- Detroit drivers
(gen_random_uuid(), 'Emily', 'Wilson', 'emily.wilson@example.com', '313-555-0201', '1985-07-12', '321 Elm St', 'Detroit', 'MI', '48201', 'car', 'Ford', 'Focus', 2019, 'Red', 'GHI789', 'DL111222333', 'MI', '2025-11-30', '3456', 'direct_deposit', '111222333', '7890', 'doc13.jpg', 'doc13.jpg', 'doc14.jpg', 'doc15.jpg', 'doc16.jpg', 'photo4.jpg', 'Allstate', 'AL111222333', 'pending', NOW() - INTERVAL '7 days', 60, 60, 2),
(gen_random_uuid(), 'David', 'Brown', 'david.brown@example.com', '313-555-0202', '1991-09-25', '654 Maple Dr', 'Detroit', 'MI', '48202', 'car', 'Chevrolet', 'Malibu', 2020, 'White', 'JKL012', 'DL444555666', 'MI', '2026-01-15', '7890', 'cashapp', NULL, NULL, 'doc17.jpg', 'doc17.jpg', 'doc18.jpg', 'doc19.jpg', 'doc20.jpg', 'photo5.jpg', 'Farmers', 'FA444555666', 'pending', NOW() - INTERVAL '4 days', 35, 35, 2),
(gen_random_uuid(), 'Lisa', 'Garcia', 'lisa.garcia@example.com', '313-555-0203', '1987-12-03', '987 Cedar Ln', 'Detroit', 'MI', '48203', 'scooter', 'Vespa', 'Primavera', 2022, 'Yellow', 'MNO345', 'DL777888999', 'MI', '2025-09-10', '1234', 'direct_deposit', '555666777', '2345', 'doc21.jpg', 'doc21.jpg', 'doc22.jpg', 'doc23.jpg', 'doc24.jpg', 'photo6.jpg', 'USAA', 'US777888999', 'pending', NOW() - INTERVAL '2 days', 20, 20, 2),

-- Cleveland drivers
(gen_random_uuid(), 'Robert', 'Miller', 'robert.miller@example.com', '216-555-0301', '1983-04-18', '147 Birch St', 'Cleveland', 'OH', '44101', 'car', 'Nissan', 'Altima', 2017, 'Gray', 'PQR678', 'DL000111222', 'OH', '2025-10-05', '4567', 'direct_deposit', '000111222', '3456', 'doc25.jpg', 'doc25.jpg', 'doc26.jpg', 'doc27.jpg', 'doc28.jpg', 'photo7.jpg', 'Liberty Mutual', 'LM000111222', 'pending', NOW() - INTERVAL '6 days', 50, 50, 3),
(gen_random_uuid(), 'Jennifer', 'Taylor', 'jennifer.taylor@example.com', '216-555-0302', '1994-01-30', '258 Spruce Ave', 'Cleveland', 'OH', '44102', 'car', 'Hyundai', 'Elantra', 2021, 'Green', 'STU901', 'DL333444555', 'OH', '2026-02-28', '5678', 'cashapp', NULL, NULL, 'doc29.jpg', 'doc29.jpg', 'doc30.jpg', 'doc31.jpg', 'doc32.jpg', 'photo8.jpg', 'Nationwide', 'NW333444555', 'pending', NOW() - INTERVAL '8 days', 45, 45, 3),
(gen_random_uuid(), 'James', 'Anderson', 'james.anderson@example.com', '216-555-0303', '1989-06-14', '369 Walnut Blvd', 'Cleveland', 'OH', '44103', 'motorcycle', 'Harley-Davidson', 'Sportster', 2019, 'Black', 'VWX234', 'DL666777888', 'OH', '2025-07-15', '8901', 'direct_deposit', '666777888', '4567', 'doc33.jpg', 'doc33.jpg', 'doc34.jpg', 'doc35.jpg', 'doc36.jpg', 'photo9.jpg', 'Dairyland', 'DL666777888', 'pending', NOW() - INTERVAL '10 days', 30, 30, 3),

-- Columbus drivers
(gen_random_uuid(), 'Amanda', 'Thomas', 'amanda.thomas@example.com', '614-555-0401', '1993-08-07', '741 Cherry St', 'Columbus', 'OH', '43201', 'car', 'Volkswagen', 'Jetta', 2020, 'Silver', 'YZA567', 'DL999000111', 'OH', '2025-12-10', '0123', 'direct_deposit', '999000111', '5678', 'doc37.jpg', 'doc37.jpg', 'doc38.jpg', 'doc39.jpg', 'doc40.jpg', 'photo10.jpg', 'Travelers', 'TR999000111', 'pending', NOW() - INTERVAL '9 days', 55, 55, 4),
(gen_random_uuid(), 'Christopher', 'Jackson', 'christopher.jackson@example.com', '614-555-0402', '1986-02-19', '852 Poplar Dr', 'Columbus', 'OH', '43202', 'car', 'Mazda', 'Mazda3', 2018, 'Blue', 'BCD890', 'DL222333444', 'OH', '2026-04-20', '1234', 'cashapp', NULL, NULL, 'doc41.jpg', 'doc41.jpg', 'doc42.jpg', 'doc43.jpg', 'doc44.jpg', 'photo11.jpg', 'MetLife', 'ML222333444', 'pending', NOW() - INTERVAL '11 days', 40, 40, 4),
(gen_random_uuid(), 'Michelle', 'White', 'michelle.white@example.com', '614-555-0403', '1990-10-12', '963 Sycamore Rd', 'Columbus', 'OH', '43203', 'car', 'Subaru', 'Impreza', 2019, 'Orange', 'EFG123', 'DL555666777', 'OH', '2025-06-25', '2345', 'direct_deposit', '555666777', '6789', 'doc45.jpg', 'doc45.jpg', 'doc46.jpg', 'doc47.jpg', 'doc48.jpg', 'photo12.jpg', 'Safeco', 'SF555666777', 'pending', NOW() - INTERVAL '12 days', 25, 25, 4);
...
-- Add some demo notifications (only if notifications table exists)
INSERT INTO notifications (user_id, title, message, type, created_at) 
SELECT 
  (SELECT id FROM craver_applications WHERE email = 'amanda.thomas@example.com'), 
  'Welcome to Crave''n!', 
  'Your driver application has been received and you''re #1 in the Columbus region queue!', 
  'info', 
  NOW() - INTERVAL '9 days'
