-- ============================================================================
-- APPLY GROUP CONVERSATIONS SYSTEM
-- ============================================================================
-- This script creates the group conversation system for executives
-- Run this in Supabase Dashboard SQL Editor after APPLY_EXEC_CONVERSATIONS.sql
-- ============================================================================

-- ============================================================================
-- CREATE GROUP CONVERSATIONS TABLES
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Group Chat feature is now available!';
  RAISE NOTICE 'Executives can create group conversations with multiple participants.';
END $$;
