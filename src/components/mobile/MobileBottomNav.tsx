...
const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ cartCount = 0, user }) => {
            ...
            return (
              ...
              >
                ...
                {tab.id === 'orders' && cartCount > 0 && (
                  <div className="absolute -top-1 right-1/4 bg-destructive text-destructive-foreground text-xs rounded-full h-5 w-5 flex items-center justify-center">
