...
export const MobileDriverDashboard: React.FC = () => {
  ...
  return <>
    ...
    <div className="fixed inset-0 h-[100dvh] w-screen bg-background overflow-hidden safe-area-top">
      ...
      <div className="fixed left-4 z-50 pointer-events-auto" style={{ top: 'calc(env(safe-area-inset-top, 44px) + 8px)' }}>
        <button
      ...
      <div className="fixed left-4 z-40 pointer-events-auto" style={{ top: 'calc(env(safe-area-inset-top, 44px) + 60px)' }}>
        <SpeedLimitSign 
      ...
      <div className="fixed inset-0 z-10 flex flex-col py-0 safe-area-top" style={{ paddingBottom: '80px' }}>
        ...
        {activeTab === 'home' && driverState === 'offline' && <>
            ...
            <div className="fixed left-4 z-20 pointer-events-auto" style={{ top: 'calc(env(safe-area-inset-top, 44px) + 16px)' }}>
        ...
        {activeTab === 'home' && driverState === 'online_searching' && <>
            {/* Change Zone Button - Top Left */}
            <div className="absolute left-4 z-20 pointer-events-auto py-0 my-[525px] mx-0 px-0" style={{ top: 'calc(env(safe-area-inset-top, 44px) + 16px)' }}>
              
            </div>

            {/* Pause Button - Top Right */}
            <div className="absolute right-7 z-20 pointer-events-auto px-0 mx-[28px]" style={{ top: 'calc(env(safe-area-inset-top, 44px) + 16px)' }}>
