          ...
          <div className="p-4">
            <nav className="space-y-1">
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-colors bg-blue-100 text-blue-900"
              >
        ...
        <div className="flex-1">
          ...
          >
            ...
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-10 right-20 w-32 h-32 bg-white rounded-full"></div>
              <div className="absolute top-32 right-40 w-24 h-24 bg-white rounded-full"></div>
              <div className="absolute bottom-20 right-16 w-40 h-40 bg-white rounded-full"></div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center mb-8">
                    ...
                    <div className="flex items-center">
                      <span className="text-teal-500 font-bold text-2xl">Crave</span>
                      <span className="text-black font-bold text-2xl ml-1">More</span>
                    </div>
                  </div>
                ...
                <div className="hidden lg:block relative">
                  <div className="relative">
                    <div className="w-64 h-64 bg-gray-200 rounded-lg shadow-lg transform rotate-3"></div>
                    <div className="absolute top-4 left-4 w-56 h-56 bg-gray-100 rounded-lg shadow-lg transform -rotate-2"></div>
                    <div className="absolute top-8 left-8 w-48 h-48 bg-gray-50 rounded-lg shadow-lg transform rotate-1"></div>
                  </div>
                </div>
              </div>
            </div>
