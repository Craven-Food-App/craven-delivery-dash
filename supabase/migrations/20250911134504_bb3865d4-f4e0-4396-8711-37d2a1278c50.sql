-- Grant admin rights to craven@usa.com user (UUID: 93a342c6-9dc2-4bf6-ab1c-0dc1d17148cd)
-- Note: This user exists in auth.users, we're granting them admin access
...
-- Insert user profile if it doesn't exist, otherwise update
DO $$
BEGIN
