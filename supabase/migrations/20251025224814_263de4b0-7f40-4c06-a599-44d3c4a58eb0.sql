...
-- Update calculate_waitlist_position with security settings
...
-- Update get_driver_queue_position with security settings
...
-- Update add_to_activation_queue with security settings
