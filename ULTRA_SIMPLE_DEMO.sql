-- Ultra Simple Demo Data - Just the basics
...
-- Insert just 2 simple driver applications with minimal columns
...
('John', 'Smith', 'john.smith@example.com', '419-555-0101', '1990-05-15', '123 Main St', 'Toledo', 'OH', '43601', 'car', 'Toyota', 'Camry', 2018, 'Silver', 'ABC123', 'DL123456789', 'OH', '2025-12-31', '1234', 'State Farm', 'SF123456789', 'pending', NOW() - INTERVAL '5 days', 25, 25, 1),
('Sarah', 'Johnson', 'sarah.johnson@example.com', '419-555-0102', '1988-03-22', '456 Oak Ave', 'Toledo', 'OH', '43602', 'car', 'Honda', 'Civic', 2020, 'Blue', 'DEF456', 'DL987654321', 'OH', '2026-03-15', '5678', 'Geico', 'GC987654321', 'pending', NOW() - INTERVAL '3 days', 40, 40, 1);
...
-- Keep both as pending for now to avoid trigger issues
...
SELECT 'Ultra simple demo data setup completed!' as status;
