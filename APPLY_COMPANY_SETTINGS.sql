-- Apply Company Settings Migration
...
DROP POLICY IF EXISTS "Executives and admins can view company settings" ON public.company_settings;
...
DROP POLICY IF EXISTS "Executives and admins can update company settings" ON public.company_settings;
